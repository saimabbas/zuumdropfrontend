    ...
    <div id="smooth-wrapper">
      <div id="smooth-content">
        <div className="zuumdrop-app">
          <main className="merchant-page driver-page">
                ...
                <div className="merchant-hero-grid">
                  ...
                  <div className="merchant-hero-grid-left">
                    ...
                    <p>
                      ...
                      You Want Then Your Definitely A Dropper. What’s a Dropper?
                      A Boss That’s works on his time and earns money on his
                      time and drops off items, food or packages on his time. So
                      Sign Up For ZuumDrop and start this adventure!
                    </p>
            ...
            <div className="why-zuumdrop-section">
              <div className="box">
                <div className="why-zuumdrop-section-content">
                  <div className="section-heading">
                    <h3 className="cursive-text">
                      <span className="cursive-text">Q</span>
                      ualifications
                  ...
                  <div className="qualifications-grid">
                    ...
                    <div className="why-zuumdrop-grid-card">
                      <h3 className="cursive-text">
                        Delivery by Scooter or Bike 🛵
                      </h3>

                      <ul>
                        <li>Be at least 18 years old</li>
                        <li>Have a motorized scooter under 50cc</li>
                        <li>Have a electric bike at least 20mph</li>
                        <li>Have a valid driver’s license in your name</li>
                        <li>
                          Submit your Social Security number for us to run a
                          background screening
            ...
            <section className="how-zuum-works-section">
              <div className="box">
                <div className="how-zuum-works-content">
                  <div className="hzwm-heading-box">
                    <h3 className="cursive-text">
                      Stepping Stones To Being A Dropper
                    </h3>
                  </div>
            ...
            <div className="steps-section">
              <div className="box">
                <div className="steps-section-grid">
                  <div className="steps-section-grid-left">
                    <h4 className="cursive-text">
                  ...
                  <div className="steps-section-grid-right">
                    <img src={FDBImg} alt="FDBImg" />
                  </div>
                </div>
              </div>
            </div>
