      ...
      <div id="smooth-content">
        <div className="zuumdrop-app">
          <main className="home-page">
                ...
                <div className="hero-section-content">
                  <div className="hero-heading-box">
                    {/* <img
                      ...
                      alt="PaperplaneImg"
                    /> */}
                    <img className="heading-swoosh" src={WhiteSwoosh} alt="" />
                    <h1 className="cursive-text">
                      You Want It, <br /> We Drop It.
                    </h1>
                  </div>
            ...
            <section className="delivering-to-section">
              <div className="box">
              ...
              <div className="delivering-grid-container">
                ...
                >
                  <div className="delivering-grid-card">
                    <img src={ETImg1} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg2} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg3} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg4} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg5} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg6} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg7} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg8} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg9} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg10} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg11} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg12} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg13} alt="ETImg2" />
                  </div>
                  <div className="delivering-grid-card">
                    <img src={ETImg14} alt="ETImg2" />
                  </div>
                </Marquee>
              </div>
            </section>
            <section className="zuum-services-section">
              <div className="box">
                <div className="zuum-services-grid">
                  <div data-speed={1.1} className="zuum-services-grid-card">
                    <div className="sgc-grd-box"></div>
                    <div className="zuum-services-grid-card-content">
                      <div>
                        <img src={PartnerImg} alt="" />
                        <h4 className="cursive-text">Partner With Us</h4>
                        <p>
                          Increase Your Restaurant Sales By Gaining New Loyal
                  ...
                  <div data-speed={1.2} className="zuum-services-grid-card">
                    ...
                    <div className="zuum-services-grid-card-content">
                      <div>
                        <img src={DropperImg} alt="" />
                        <h4 className="cursive-text">Become A Dropper</h4>
                        <p>
                          As A Delivery Driver You Create Your Schedule, Work
                  ...
                  <div data-speed={1.3} className="zuum-services-grid-card">
                    ...
                    <div className="zuum-services-grid-card-content">
                      <div>
                        ...
                        <h4 className="cursive-text">Download Our App</h4>
                        <p>
                          An App That’s Easier, Convenient To Use And Get What
