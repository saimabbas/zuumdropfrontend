...
const Home = () => {
  ...
  return (
    <div id="smooth-wrapper">
                ...
                <div className="merchant-hero-grid">
                  <div className="merchant-hero-grid-right">
                    <div className="get-started-box">
                      ...
                      <Form.Check
                        inline
                        label="By Continuing You Agree To our Terms and Privacy Policy"
                        name="group1"
                        type={"checkbox"}
                        id={111}
                      />
                ...
                <div className="why-zuumdrop-section-content">
                  <div className="section-heading">
                    <h3 className="cursive-text">
                      <span className="cursive-text">W</span>
                      hy ZuumDrop
                  ...
                  <div className="why-zuumdrop-grid">
                    <div className="why-zuumdrop-grid-card">
                      ...
                      <p>
                        We will help you achieve your goals you have for your
                        Resturant or Business By Scaling Your Visibility So You
                    ...
                    <div className="why-zuumdrop-grid-card">
                      ...
                      <p>
                        ...
                        Stress, We Have In House Droppers AkA Delivery Drivers
                        That Make Getting Your Great Food Or Products Fast And
                    ...
                    <div className="why-zuumdrop-grid-card">
                      ...
                      <p>
                        We Collect Data From Customers On Our App And We
                        Redirect That Data To You So You Can Gain Insights On
                        Making Your Business Better And Profitable.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div className="chat-icon merchant-chat-icon">
        <BsChatLeftDotsFill />
      </div>
    </div>
  );
